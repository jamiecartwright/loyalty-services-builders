...
VALUES
  ...
  ('f6060606-1006-4000-8000-000000000006',
   'checklist_form_completion', 'Form Completion',
   'Complete a custom form such as an emergency contact sheet',
   'clipboard-text-regular',
   'EARN_POINTS', 'HOME', 'FLAT', 'BILT_POINTS',
   'PROPERTY', TRUE, 6, 'f6060606-0001-4000-8000-000000000001');
...
VALUES
  ...
  ('f6060606-4006-4000-8000-000000000001', 'f6060606-1006-4000-8000-000000000006', 'mobile', 'full'),
  -- Web
  ...
  ('f6060606-400c-4000-8000-000000000001', 'f6060606-1006-4000-8000-000000000006', 'web', 'full');


-- ============================================================
-- PART 6: OFFER BUILDER FLOW STEPS
-- ============================================================
-- 5 steps per flow × 12 flows = 60 rows.
...
INSERT INTO offer_builder_flow_steps (id, flow_id, step_id, step_order, is_required, is_skip_allowed, is_back_navigation_allowed, is_visible) VALUES
  ('f6060606-5006-0001-8000-000000000001', 'f6060606-4006-4000-8000-000000000001', 'f6060606-2001-4000-8000-000000000001', 1, true, false, false, true),
  ('f6060606-5006-0002-8000-000000000001', 'f6060606-4006-4000-8000-000000000001', (SELECT id FROM offer_builder_steps WHERE step_type = 'audience_definition' LIMIT 1), 2, true, false, true, true),
  ('f6060606-5006-0003-8000-000000000001', 'f6060606-4006-4000-8000-000000000001', 'f6060606-2002-4000-8000-000000000001', 3, false, false, true, true),
  ('f6060606-5006-0004-8000-000000000001', 'f6060606-4006-4000-8000-000000000001', (SELECT id FROM offer_builder_steps WHERE step_type = 'confirmation' LIMIT 1), 4, true, false, true, true),
  ('f6060606-5006-0005-8000-000000000001', 'f6060606-4006-4000-8000-000000000001', (SELECT id FROM offer_builder_steps WHERE step_type = 'success_handoff' LIMIT 1), 5, true, false, false, true);
...
-- Web: Form Completion
INSERT INTO offer_builder_flow_steps (id, flow_id, step_id, step_order, is_required, is_skip_allowed, is_back_navigation_allowed, is_visible) VALUES
  ('f6060606-500c-0001-8000-000000000001', 'f6060606-400c-4000-8000-000000000001', 'f6060606-2001-4000-8000-000000000001', 1, true, false, false, true),
  ('f6060606-500c-0002-8000-000000000001', 'f6060606-400c-4000-8000-000000000001', (SELECT id FROM offer_builder_steps WHERE step_type = 'audience_definition' LIMIT 1), 2, true, false, true, true),
  ('f6060606-500c-0003-8000-000000000001', 'f6060606-400c-4000-8000-000000000001', 'f6060606-2002-4000-8000-000000000001', 3, false, false, true, true),
  ('f6060606-500c-0004-8000-000000000001', 'f6060606-400c-4000-8000-000000000001', (SELECT id FROM offer_builder_steps WHERE step_type = 'confirmation' LIMIT 1), 4, true, false, true, true),
  ('f6060606-500c-0005-8000-000000000001', 'f6060606-400c-4000-8000-000000000001', (SELECT id FROM offer_builder_steps WHERE step_type = 'success_handoff' LIMIT 1), 5, true, false, false, true);
...
INSERT INTO offer_builder_flow_step_elements (id, flow_step_id, element_id, element_order, is_required, is_visible, default_value, section) VALUES
  ...
  ('f6060606-6006-0001-8000-000000000001', 'f6060606-5006-0001-8000-000000000001', (SELECT id FROM offer_builder_elements WHERE internal_name = 'task_name' LIMIT 1), 1, true, true, 'Complete form', 'body'),
  ('f6060606-6006-0001-8000-000000000002', 'f6060606-5006-0001-8000-000000000001', (SELECT id FROM offer_builder_elements WHERE internal_name = 'task_description' LIMIT 1), 2, false, true, null, 'body'),
  ('f6060606-6006-0001-8000-000000000003', 'f6060606-5006-0001-8000-000000000001', (SELECT id FROM offer_builder_elements WHERE internal_name = 'is_completion_required' LIMIT 1), 3, true, true, 'false', 'body'),
  ...
  ('f6060606-600c-0001-8000-000000000001', 'f6060606-500c-0001-8000-000000000001', (SELECT id FROM offer_builder_elements WHERE internal_name = 'task_name' LIMIT 1), 1, true, true, 'Complete form', 'body'),
  ('f6060606-600c-0001-8000-000000000002', 'f6060606-500c-0001-8000-000000000001', (SELECT id FROM offer_builder_elements WHERE internal_name = 'task_description' LIMIT 1), 2, false, true, null, 'body'),
  ('f6060606-600c-0001-8000-000000000003', 'f6060606-500c-0001-8000-000000000001', (SELECT id FROM offer_builder_elements WHERE internal_name = 'is_completion_required' LIMIT 1), 3, true, true, 'false', 'body');
...
INSERT INTO offer_builder_flow_step_elements (id, flow_step_id, element_id, element_order, is_required, is_visible, default_value, section) VALUES
  ...
  ('f6060606-6006-0002-8000-000000000001', 'f6060606-5006-0002-8000-000000000001', (SELECT id FROM offer_builder_elements WHERE internal_name = 'audience_selection' LIMIT 1), 1, false, true, 'all', 'body'),
  ('f6060606-6006-0002-8000-000000000002', 'f6060606-5006-0002-8000-000000000001', (SELECT id FROM offer_builder_elements WHERE internal_name = 'guest_tags' LIMIT 1), 2, false, true, null, 'body'),
  ('f6060606-6006-0002-8000-000000000003', 'f6060606-5006-0002-8000-000000000001', (SELECT id FROM offer_builder_elements WHERE internal_name = 'guest_filters' LIMIT 1), 3, false, true, null, 'body'),
  ('f6060606-6006-0002-8000-000000000004', 'f6060606-5006-0002-8000-000000000001', (SELECT id FROM offer_builder_elements WHERE internal_name = 'audience_count' LIMIT 1), 4, false, true, null, 'footer'),
  ...
  ('f6060606-600c-0002-8000-000000000001', 'f6060606-500c-0002-8000-000000000001', (SELECT id FROM offer_builder_elements WHERE internal_name = 'audience_selection' LIMIT 1), 1, false, true, 'all', 'body'),
  ('f6060606-600c-0002-8000-000000000002', 'f6060606-500c-0002-8000-000000000001', (SELECT id FROM offer_builder_elements WHERE internal_name = 'guest_tags' LIMIT 1), 2, false, true, null, 'body'),
  ('f6060606-600c-0002-8000-000000000003', 'f6060606-500c-0002-8000-000000000001', (SELECT id FROM offer_builder_elements WHERE internal_name = 'guest_filters' LIMIT 1), 3, false, true, null, 'body'),
  ('f6060606-600c-0002-8000-000000000004', 'f6060606-500c-0002-8000-000000000001', (SELECT id FROM offer_builder_elements WHERE internal_name = 'audience_count' LIMIT 1), 4, false, true, null, 'footer');
...
INSERT INTO offer_builder_flow_step_elements (id, flow_step_id, element_id, element_order, is_required, is_visible, default_value, section) VALUES
  ...
  ('f6060606-6006-0004-8000-000000000001', 'f6060606-5006-0004-8000-000000000001', (SELECT id FROM offer_builder_elements WHERE internal_name = 'offer_name' LIMIT 1), 1, true, true, '{task_name}', 'body'),
  ('f6060606-6006-0004-8000-000000000002', 'f6060606-5006-0004-8000-000000000001', (SELECT id FROM offer_builder_elements WHERE internal_name = 'input_summary' LIMIT 1), 2, false, true, null, 'body'),
  ('f6060606-6006-0004-8000-000000000003', 'f6060606-5006-0004-8000-000000000001', (SELECT id FROM offer_builder_elements WHERE internal_name = 'create_offer' LIMIT 1), 3, false, true, null, 'cta'),
  ...
  ('f6060606-600c-0004-8000-000000000001', 'f6060606-500c-0004-8000-000000000001', (SELECT id FROM offer_builder_elements WHERE internal_name = 'offer_name' LIMIT 1), 1, true, true, '{task_name}', 'body'),
  ('f6060606-600c-0004-8000-000000000002', 'f6060606-500c-0004-8000-000000000001', (SELECT id FROM offer_builder_elements WHERE internal_name = 'input_summary' LIMIT 1), 2, false, true, null, 'body'),
  ('f6060606-600c-0004-8000-000000000003', 'f6060606-500c-0004-8000-000000000001', (SELECT id FROM offer_builder_elements WHERE internal_name = 'create_offer' LIMIT 1), 3, false, true, null, 'cta');
...
VALUES
  ...
  ('a1010101-0006-4000-8000-000000000006', 'COMPLETE_FORM', '{"formType": "custom"}'::jsonb);
...
VALUES
  ...
  ('d4040404-0006-4000-8000-000000000006', 'b2020202-0001-4000-8000-000000000001', 'Form Completion', 'NONE', 'a1010101-0006-4000-8000-000000000006');
...
VALUES
  ...
  ('e5050505-0006-4000-8000-000000000006',
   'c3030303-0001-4000-8000-000000000001', '3b4c5d6e-7f8a-9b0c-1d2e-3f4a5b6c7d8e',
   6, false, 'Complete Form', 'clipboard-text-bold',
   '[{"icon": null, "order": 1, "value": "Ask residents to fill out a custom form such as an emergency contact sheet or pet registration."}]'::jsonb,
   'OFFER', 'd4040404-0006-4000-8000-000000000006',
   '/portal-gateway/v1/offer-builder/flows?rewardTypeId=f6060606-1006-4000-8000-000000000006&platform={platform}&audienceType=full',
   false);
